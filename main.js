document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'nav-about': 'About',
            'welcome-to-starspace': 'Welcome to Starspace',
            'header-paragraph': 'Where Computer Science Meets the Future',
        ...
        el: {
            ...
            'nav-about': 'Σχετικά',
            'welcome-to-starspace': 'Καλώς ήρθατε στο Starspace',
            'header-paragraph': 'Εκεί όπου η Επιστήμη των Υπολογιστών Συναντά το Μέλλον',
